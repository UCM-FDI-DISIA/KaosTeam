...
/*Struct con los datos de input de un bot�n espec�fico*/
struct InputButton {
    bool keyDOWN; //True en el momento que el bot�n es pulsado
    bool pressed; //True 
    bool keyUP;

    InputButton() : keyDOWN(false), pressed(false), keyUP(false) {};

    /*Esta conversi�n deber�a mantener el comportamiento anterior para las clases en las que
